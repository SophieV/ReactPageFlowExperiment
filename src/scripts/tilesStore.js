...
let addTile = function(route, below) {
  ...
  if (routeUsed == null){
    routeUsed = findNextAvailableRoute((below?_store.lastRoutePopulatedBelow:_store.lastRoutePopulatedAbove), below);  
  }
  ...
  if (routeUsed != null) {
    ...
    _store.lastRoutePopulated = routeUsed;
    console.log('adding tile for route ' + routeUsed);
  } else {
